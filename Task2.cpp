...
if (unit == "millimeters")
cout << "Volume of Pyramid is: " << volume * 1000000000 << " Cubic Millimeters" << endl;
if (unit == "centimeters")
cout << "Volume of Pyramid is: " << volume * 1000000 << " Cubic Centimeters" << endl;
if (unit == "meters")
cout << "Volume of Pyramid is: " << volume << " Cubic Meters" << endl;
if (unit == "kilometers")
cout << "Volume of Pyramid is: " << volume / 1000000000 << " Cubic Kilometers" << endl;
